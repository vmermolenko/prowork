...
public class HibLocation {
  ...
  public HibLocation(Long id, Long idWorker, Double latitude, Double longtitude, Timestamp dateFrom) {
    this.id = id;
  ...
  public boolean equals(Object o) {
    ...
    HibLocation location = (HibLocation) o;
