...
public class NumberWorker {
  ...
  public NumberWorker(Long id, Long idOrder, Long idWorker, Long numberWorker, Timestamp dateFrom, Timestamp dateTo, Timestamp dateCancel) {
    this.id = id;
  ...
  public boolean equals(Object o) {
    ...
    NumberWorker that = (NumberWorker) o;
